...
Your piece may, of course, be created using Nyquist alone. **We will have an award for the best computer music composition (as judged by peers) that is _fully executable in Nyquist_**, i.e., not mixed with any external software. Your work will be immortalized online as a winner of the _Dannenberg Award_ for executable computer music, alongside winners from past and future editions of the course. The winner will be announced at the final exam and will also receive a small memento to commemorate their achievement. Please specify in your `andrewid_p7_answers.txt` file if your submission qualifies (fully realized in Nyquist).
