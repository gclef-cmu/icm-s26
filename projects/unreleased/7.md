...
- SUBMIT HERE: [https://forms.gle/4crritbCFXrUpEMz5 ](https://forms.gle/vUQ2VLrVCcSazHY16). Must submit under your CMU Andrew Google Drive account. 100MB maximum. You may revise your submission up until the deadline. You may need to press "Submit a new response" instead of "Edit response" - we will grade the file with the latest timestamp before the submission deadline. Contact us if there are any issues with file upload.
