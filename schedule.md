...
[Click here]($CALENDAR) to subscribe to the course's Google Calendar.

**Week 1: Introduction to Computer Music**

- Monday, January 12 – Fundamentals of Sound and Sampling, Audacity tutorial ([1.1-1.2]($BOOKCHROOT/chapter01.pdf))
...
- Wednesday, January 21 – Unit Generators, Envelopes/Piece-wise Functions, Programming Scores ([2.1]($BOOKCHROOT/chapter02.pdf), [2.4]($BOOKCHROOT/chapter02.pdf), [2.6-2.7]($BOOKCHROOT/chapter02.pdf), [4.5-4.8]($BOOKCHROOT/chapter04.pdf))
...
- Monday, January 26 – Additive / Wavetable Synthesis, Basic Waveforms ([1.2.5]($BOOKCHROOT/chapter01.pdf), [2.3]($BOOKCHROOT/chapter02.pdf), [2.5]($BOOKCHROOT/chapter02.pdf))
- Wednesday, January 28 – Frequency vs. Time, Fourier Analysis ([3.1-3.2]($BOOKCHROOT/chapter03.pdf))
...
- Monday, February 23 – Filters ([McFee 3]($MCFEEROOT/ch03-convolution/intro.html), [Dannenberg 7.2]($BOOKCHROOT/chapter07.pdf))
